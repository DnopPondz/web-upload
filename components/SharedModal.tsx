...
export default function SharedModal({
  ...
  return (
    ...
    >
      <div className="relative z-50 mx-auto flex w-full max-w-7xl justify-center">
        <div
          className="relative flex aspect-[4/5] w-full max-h-[calc(100vh-6rem)] items-center overflow-hidden rounded-3xl border border-white/10 bg-black/30 shadow-[0_25px_60px_rgba(0,0,0,0.55)] backdrop-blur-lg sm:aspect-[3/2] wide:h-full xl:taller-than-854:h-auto"
          {...handlers}
        >
          {/* Main image */}
          <div className="w-full overflow-hidden">
            <div className="relative flex aspect-[4/5] items-center justify-center sm:aspect-[3/2]">
          ...
          {navigation && (
            <div className="fixed inset-x-0 bottom-0 z-40 overflow-hidden bg-gradient-to-b from-black/0 to-black/60">
              <motion.div
                initial={false}
                className="mx-auto mt-6 mb-6 flex aspect-[3/2] h-14 px-4 sm:px-6 md:px-10"
              >
